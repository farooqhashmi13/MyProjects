namespace Online_Exam.Migrations
{
    ...
    public partial class onlineExam : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.TestModels", t => t.TestId, cascadeDelete: true)
                .Index(t => t.TestId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.TestModels", "UserId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.TestModels", new[] { "UserId" });
